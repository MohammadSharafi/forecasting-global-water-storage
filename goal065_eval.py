...
def cmd_selftest(_a):
    ...
    cases = [
        ...
        (D(-0.01, -0.01, -0.01, -0.01, -0.01), HELPS, None),
        (D(-0.1, -0.1, -0.1, -0.002, -0.1), HELPS,
        ...
        (D(-0.003, -0.003, -0.003, -0.003, -0.003), HELPS, None),
        (D(-0.0003, -0.001, -0.001, -0.001, -0.001), HELPS, None),
        (D(-0.00029, -0.01, -0.01, -0.01, -0.01), REJECT, None),
        (D(-0.05, -0.05, -0.05, -0.05, +0.001), REJECT, None),
        (D(+0.01, +0.01, -0.05, -0.05, -0.05), REJECT, None),
        (D(-0.05, -0.05, -0.05, -0.05, 0.0), REJECT, None),
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        assert np.array_equal(p, [2.0, 3.0]) and len(fs) == 2, (p, fs)
        assert load_arm("E", "_x1", mats=td)[0] is None
