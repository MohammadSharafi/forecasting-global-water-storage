"""v4: autoregressive lags of OBSERVED TWS relative to t_known (1,2,3,6,12 months back)
and a per-cell linear trend over the 24 observed months before t_known. Only observed
history is used, so this is leak-free by construction."""
...
def add_ar(r, obs_all):
    ...
    # 24-month trend: slope of TWS vs months, per (cell, t_known), from observations in (t_known-24, t_known]
