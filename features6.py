"""v6: trend-aware anchors. Recent-window climatology (last 60 months before t_known),
60-month per-cell trend, and anomaly of the last observation relative to the recent
window instead of the 2002-2015 mean."""
import polars as pl
