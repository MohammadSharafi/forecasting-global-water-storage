"""Does a dedicated h=1 model (33% of test rows, TWS_t observed) beat the shared model?
Also a deeper/slower variant for ensemble diversity. Both layouts."""
...
for sfx in ["","_B"]:
    ...
    # deeper/slower variant for diversity
