"""Evaluate on BOTH layouts: (i) v5 + recent anchors, (ii) same with long-term anchors removed.
Reports RMSE and mean bias -> tells whether de-anchoring fixes the positive bias."""
