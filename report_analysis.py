"""Evidence for the trustworthiness report: SHAP importances, error by latitude band /
horizon / month / anomaly regime on the leak-free validation split, and a CodeCarbon
estimate of one training run. Runs alone; writes out/report/*."""
...
# --- spatial error map (mean error per cell) ---
...
# --- CodeCarbon: one training run of the final configuration on the on-disk matrix ---
