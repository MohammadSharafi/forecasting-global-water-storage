"""Fallback final: v6 features + recent-year weights, 5 seeds; blend 50/50 with the existing
3-seed v5 predictions; smooth. Writes out/sub_final_fallback_6dp.csv."""
