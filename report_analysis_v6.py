"""Report evidence for the FINAL stack (v6 features + recent-year weights): SHAP, error
breakdowns by latitude/horizon/anomaly regime, error map, CodeCarbon. Layout A. Runs alone."""
