"""Post-processing experiments on saved validation predictions (both layouts):
 blend of v5 + v6w-ncep, per-horizon shrinkage of the predicted change, spatial smoothing,
 and within-block trajectory smoothing along the horizon."""
...
for sfx in ["","_B"]:
    ...
    # per-horizon shrink/expand of change
    ...
    # within-block trajectory smoothing: for same (cell, t_known), predictions at horizons h-1,h,h+1 -> smooth along h
