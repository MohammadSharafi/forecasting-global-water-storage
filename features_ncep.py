"""NCEP/NCAR Reanalysis-1 monthly surface water-balance fields (public, no login, updated
within days). Regridded from the T62 Gaussian grid to the challenge's 1-degree .5-centred
cells by bilinear interpolation. Units -> mm/month where meaningful:
  prate kg/m2/s -> P mm/month ; lhtfl W/m2 -> E mm/month (latent heat 2.5e6 J/kg) ;
  runof (kg/m2) kept as relative signal ; weasd kg/m2 = SWE mm ; soilw (fraction) x depth -> mm."""
...
def load_ncep(lats, lons, start="2001-01-01", end="2019-06-01"):
    ...
    for name,f in FILES.items():
        ...
        # NCEP lon is 0..360; make -180..180 and sort
